...
export default function SubdomainLogin() {
  ...
  const [loadingType, setLoadingType] = useState<'email' | 'google' | 'magic' | 'redirect' | null>(null)
  ...
  useEffect(() => {
    ...
    if (sub) {
      getOrganizationBySubdomain(sub).then(setOrganization)
    }
  }, [])
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              The subdirectory "{subdirectory}" is not associated with any organization.
            </p>
            <a
              href="https://trytrainr.com/login"
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            {brandLogo ? (
              <img src={brandLogo} alt={organization?.name} className="w-16 h-16 mx-auto mb-4 rounded-2xl object-cover" />
            ) : (
              <div 
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              Sign in to {organization?.name || 'Trainr'}
            </h1>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <button
              ...
              style={{ backgroundColor: brandColor }}
            >
              {isLoading && loadingType === 'redirect' ? (
                <>
          ...
          {/* Note about canonical login */}
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-blue-800 text-sm text-center">
              🔒 For security, authentication is handled on our main domain. 
